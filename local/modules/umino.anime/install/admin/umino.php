...
<tr>
    <td>
        <form method="post" action="<?= $APPLICATION->GetCurPage() ?>" enctype="multipart/form-data" name="post_form_2" id="post_form_2">
            <?= bitrix_sessid_post() ?>
            ...
            <br>
            <br>
            <input class="adm-btn" type="submit" name="Update_tab2" value="Сохранить" title="Сохранить">
        </form>
    </td>
</tr>
